...
<body>
    ...
    <header class="header">
        <!-- Header Main -->
        <div class="header-main style--three love-sticky">
            <div class="container">
                                ...
                                <div class="nav-wrap-inner">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li class="current-menu-parent">
                                            <a href="#">Explore</a>
                                            <ul class="sub-menu">
                                                <li class="current-menu-children"><a href="explore.html">Explore</a>
                                                </li>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 order-1 order-lg-0">
                    ...
                    <div class="filter-options d-flex flex-wrap justify-content-center justify-content-lg-start">
                        <select class="select-rounded mb-10 lg me-4">
                            ...
                            <option value="Meka_Verse">Art</option>
                            <option value="music">Music</option>
                            <option value="video_game_items">Video Game Items</option>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 d-flex justify-content-center mt-30">
                    <a href="#" class="btn"><img src="assets/img/icons/btn-loadmore.svg" alt="" class="svg"> Load
                        More</a>
                </div>
            </div>
        </div>
